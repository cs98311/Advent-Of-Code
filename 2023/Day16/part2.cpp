...
int main()
{
  ...
  std::thread T(top_row);
  std::thread B(bottom_row);
  std::thread L(left_col);
  std::thread R(right_col);
  ...
  std::cout << "Back to main thread ID = " << std::this_thread::get_id() << std::endl;
...
void top_row()
{ // top row
  std::cout << "Started top row thread ID = " << std::this_thread::get_id() << std::endl;
...
void bottom_row()
{ // bottom row
  std::cout << "Started bottom row thread ID = " << std::this_thread::get_id() << std::endl;
...
void left_col()
{ // leftmost column
  std::cout << "Started left column thread ID = " << std::this_thread::get_id() << std::endl;
...
void right_col()
{ // rightmost column
  std::cout << "Started right column thread ID = " << std::this_thread::get_id() << std::endl;
